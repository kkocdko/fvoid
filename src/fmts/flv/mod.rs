...
impl VoidFLV {
    pub fn data(&self) -> Vec<u8> {
        ...
        ret.extend(T_2);
        let filesize_idx = ret.len(); // mark index here, rewrite it later
        ...
        for i in 0..frame_count {
            ...
            timestamp.rotate_left(1); // move first byte to end
...
const T_2: &[u8] = &[
    ...
    0x00, /* filesize (double, 8 bytes) */
];
const T_3: &[u8] = &[0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0xC3];
const T_4: &[u8] = &[0x09, 0x00, 0x00, 0x0F /* timestamp, 4 bytes */];
// timestamp example: 288e5ms, [01 b7 74 00], move `01` to end, [b7 74 00 01]
const T_5: &[u8] = &[
    //      keyframe [vvvv]
    0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x84, 0x00, 0x02, 0x02, 0x11, 0x26, 0x20, 0x20, 0x20, 0x21,
    0xFF, 0xFE, 0x00, 0x00, 0x00, 0x1A,
];
